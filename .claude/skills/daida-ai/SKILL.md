...
```bash
echo 'アウトラインMarkdown' | .venv/bin/python .claude/skills/daida-ai/scripts/generate_outline.py output/outline.md --stdin
```
...
```bash
echo 'JSON文字列' | .venv/bin/python .claude/skills/daida-ai/scripts/enrich_outline.py output/slide_spec.json --stdin
```
